...
import { login, getCurrentUser } from "../auth"; // <-- importando sua função
  ...
  const handleSubmit = (e) => {
    ...
    if (success) {
      ...
      if (user.role === "admin") {
        ...
        navigate("/dashboard"); // user comum vai para dashboard simples
      }
    } else {
    ...
    //if (success) {
     // navigate("/admin/dashboard"); // vai abrir sidebar e dashboard
    //} else {
      //setError("Usuário ou senha inválidos!");
    //}
  };
